...
const heroPhoto = "https://ik.imagekit.io/lzzlwueda/3.jpeg?tr=h-1000,w-1000,cm-extract,fo-face";
      ...
      >
        ...
        <div className="flex flex-col items-center shrink-0">
          <img
            ...
            className="w-28 h-28 sm:w-36 sm:h-36 rounded-full object-cover border-2 border-[#915eff]/50 shadow-lg"
          />
          <p className="mt-3 text-white/90 text-xs sm:text-sm text-center max-w-[200px] sm:max-w-[220px] leading-tight">
            Priyanshu Sahani
            <br />
            Madan Mohan Malaviya University of Technology
            <br />
            BTech Information Technology 2022-26
          </p>
          <div className="flex gap-2 mt-3 opacity-80">
            <a
              href="https://github.com/sahanipriyanshu"
              target="_blank"
              rel="noreferrer"
              className="w-8 h-8 rounded-full flex justify-center items-center bg-tertiary/80 hover:bg-[#915eff]/80 transition-colors"
              aria-label="GitHub"
            >
            ...
            <a
              href="https://www.linkedin.com/in/priyanshuu-sahani/"
              target="_blank"
              rel="noreferrer"
              className="w-8 h-8 rounded-full flex justify-center items-center bg-tertiary/80 hover:bg-[#915eff]/80 transition-colors"
              aria-label="LinkedIn"
            ...
            <a
              href="https://www.instagram.com/priyanshuu_sahani/"
              target="_blank"
              rel="noreferrer"
              className="w-8 h-8 rounded-full flex justify-center items-center bg-tertiary/80 hover:bg-[#915eff]/80 transition-colors"
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16" className="text-white">
                ...
                <path d="M4 0h5.293A1 1 0 0 1 10 .293L13.707 4a1 1 0 0 1 .293.707V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm5.5 1.5v2a1 1 0 0 0 1 1h2l-3-3zM9.5 0H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V0z" />
              </svg>
            </a>
          </div>
        </div>
        ...
        <div className="min-w-0">
          ...
          <p className={`${styles.heroSubText} mt-2 text-white`}>
            i develop 3d visuals, full stack <br className="sm:block hidden" />{" "}
